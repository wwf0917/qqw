...
cd /usr/local
git clone https://github.com/wwf0917/qs/shadowsocksr/shadowsocksr.git
git clone https://github.com/wwf0917/qqw/SSR-Bash-Python.git
...
wget -N --no-check-certificate -O /usr/local/bin/ssr https://raw.githubusercontent.com/wwf0917/qqw/master/ssr
